...
function createSystem(){
	...
	$.colorbox({href:webRoot+"/module/menu-input.htm?parentMenuId="+currentMenuId+"&isCreateSystem="+isCreateSystem,iframe:true, innerWidth:500, innerHeight:300,overlayClose:false,title:"创建系统"});
}
//判断是否选择一个菜单
function isSelected(){
	if(!currentMenuId||typeof(currentMenuId)=="undefined"){
