...
<body>
	<div class="ui-layout-center">
		<div class="opt-body">
		<form id="inputForm" action="/ems/test/addDept.htm"  method="post">
				<table>
					<tr><td>path</td><td><input name="path" /><font color="red">*</font></td><td>名称</td><td><input name="name" /><font color="red">*</font></td></tr>
