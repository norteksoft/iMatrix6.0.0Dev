	...
	<script type="text/javascript" src="${ctx}/js/order.js" ></script>
		<script type="text/javascript">
			...
			function selectPersonCallback(){
				$("#customerLoginName").attr("value",ztree.getLoginName());
				$("#customerId").attr("value",ztree.getId());
			}
						...
						<form  id="expenseReportForm" name="expenseReportForm" method="post" action="">
							...
							<table>
								<tr>
									...
									<td>用户名称</td>
									<td><input id="customer" name="customer" value="${customer }" readonly="readonly"/><input id="customerLoginName" type="hidden" name="customerLoginName"/><input id="customerId" type="hidden" name="customerId"/><button onclick="selectPerson()" type="button">选择</button></td>
								</tr>
								<tr>
									<td>邮编</td>
