...
@Entity
@Table(name="ES_PLAN_TASK")
public class PlanTask extends IdEntity{
	...
	public PlanTask(String taskName,Date beginDate,Date endDate,Integer layer,String code,String document,
