...
import com.norteksoft.acs.base.utils.MenuUtils;
...
public class BusinessSystemAction extends CRUDActionSupport<BusinessSystem> {
	...
	private Page<BusinessSystem> page = new Page<BusinessSystem>(Page.EACH_PAGE_TWENTY,true);
	private Page<FunctionGroup> pageFunctionGroup = new Page<FunctionGroup>(Page.EACH_PAGE_TWENTY,true);
	...
	public String save() throws Exception {
		...
		//去字段两边的空格
		String codek=businessSystem.getCode().trim();
		String namek=businessSystem.getName().trim();
		String pathk=businessSystem.getPath().trim();
		String parentcodek=businessSystem.getParentCode().trim();
		businessSystem.setCode(codek);
		businessSystem.setName(namek);
		businessSystem.setPath(pathk);
		businessSystem.setParentCode(parentcodek);
