...
public class TaskSetting implements Serializable{
	...
	private String assignmentTransactorIds;//指定的办理人,多个办理人id以逗号隔开
	...
	public String getAssignmentTransactorIds() {
		return assignmentTransactorIds;
	}
	public TaskSetting setAssignmentTransactorIds(String assignmentTransactorIds) {
		this.assignmentTransactorIds = assignmentTransactors;
		return this;
	}
