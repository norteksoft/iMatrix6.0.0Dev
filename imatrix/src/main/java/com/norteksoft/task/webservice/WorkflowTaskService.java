...
public interface WorkflowTaskService {
	 ...
	 * @return
	 */
	Page<WorkflowTask> getDelegateTasks(Long companyId, String loginName,Long userId, Page<WorkflowTask> page);
	
	Page<WorkflowTask> getDelegateTasksByActive(Long companyId, String loginName,Long userId, Page<WorkflowTask> page, boolean isEnd);
	
	Page<WorkflowTask> getTaskAsTrustee(Long companyId, String loginName,Long userId, Page<WorkflowTask> page, boolean isEnd);
	
	Integer getDelegateTasksNum(Long companyId, String loginName,Long userId);
	
	Integer getDelegateTasksNumByActive(Long companyId, String loginName,Long userId, Boolean isCompleted);
	
	Integer getTrusteeTasksNum(Long companyId, String loginName,Long userId, Boolean isCompleted);
	...
	void getAllTasksByUser(Long companyId, Long userId, Page<WorkflowTask> page);
	List<WorkflowTask> getAllTasksByUser(Long companyId, String loginName);
	List<WorkflowTask> getAllTasksByUser(Long companyId, Long userId);
	...
	List<Long> getParticipantsTransactorId(Long companyId, String instanceId);
	 ...
	 * @return 任务集合
	 */
	public List<WorkflowTask> getTasksOrderByWdfName(String definitionName,Long userId);
	/**
	 * 根据已完成的任务名，获得 已完成的任务
	 */
