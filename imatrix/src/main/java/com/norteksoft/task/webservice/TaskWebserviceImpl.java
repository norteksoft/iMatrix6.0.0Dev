...
public class TaskWebserviceImpl implements TaskWebservice{
	...
	public String personalTasks(List<String> prmtNames, List<String> prmtValues) {
		...
		return personalTasks(loginName,userId, companyId, 5,"createdTime");
	}
	
	@Transactional(readOnly=true)
	public String personalTasks(String loginName,Long userId, Long companyId, Integer size, String order) {	
		return getTaskTable(loginName,userId,companyId,size,order,null);
	}
	@Transactional(readOnly=true)
	public String detailTasks(String loginName,Long userId, Long companyId, Integer size, String order, String typeName) {	
		return getTaskTable(loginName,userId,companyId,size,order,typeName);
	}
	
	private String getTaskTable(String loginName,Long userId, Long companyId, Integer size, String order, String typeName){
