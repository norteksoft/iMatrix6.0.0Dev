...
public void notify(EventListenerExecution execution) {
	...
	//数据库方言
	  ...
	  if(execution.getVariable(CommonStrings.CREATOR_ID)!=null){
		  creatorId = execution.getVariable(CommonStrings.CREATOR_ID).toString();
	  }
	...
	private Set<String> getEmailsInformCondition(String myProcessId){
		...
		UserParseCalculator upc = WebUtil.getUserParseInfor(processId,creator,creatorId,processAdmin,processAdminId);
