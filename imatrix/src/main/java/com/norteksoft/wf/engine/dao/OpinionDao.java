...
public class OpinionDao extends HibernateDao<Opinion, Long>{
	...
	public List<Opinion> getOpinionsBytaskId(Long taskId,String loginName) {
		return find("from Opinion o where o.taskId=? and o.creator=? order by o.createdTime", taskId,loginName);
	}
	
	public List<Opinion> getOpinionsByWfdId(Long wfdId,String loginName) {
		return find("from Opinion o where o.workflowId=? and o.creator=? order by o.createdTime", wfdId,loginName);
	}
	...
	public List<Opinion> getOpinionsExceptCustomField(String workflowId,
			String customField) {
		String hql = "from Opinion d where d.workflowId=? and (d.customField<>? or d.customField is null) order by d.createdTime desc";
