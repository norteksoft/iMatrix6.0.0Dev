...
public class WorkflowInfo {
	 ...
	 */
	@Transient
	protected String newTransactor;//新办理人
	@Transient
	protected String newTransactorId;//新办理人id，多个办理人之间以逗号隔开
	...
	public String getNewTransactorId() {
		return newTransactorId;
	}
	public void setNewTransactorId(String newTransactorId) {
		this.newTransactorId = newTransactorId;
	}
