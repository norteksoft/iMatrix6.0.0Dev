...
public class InstanceHistoryDao extends HibernateDao<InstanceHistory, Long>{
	...
	public List<InstanceHistory> getInstanceHistoryByProcessId(String instanceId){
		return find("from InstanceHistory ih where ih.companyId=? and ih.instanceId=? order by ih.id", 
