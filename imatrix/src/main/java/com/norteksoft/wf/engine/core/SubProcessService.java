...
public class SubProcessService implements ExternalActivityBehaviour{
	...
	private void init(ActivityExecution execution){
		...
		String creator = execution.getVariable(CommonStrings.CREATOR).toString();
		...
		if(StringUtils.isNotEmpty(creatorId))subprocessParse.setCreatorId(Long.parseLong(creatorId));
