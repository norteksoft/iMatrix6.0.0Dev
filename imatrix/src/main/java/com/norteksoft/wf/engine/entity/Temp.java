...
public class Temp {
	...
	private List<HistoryWorkflowTask> historyTask;  //详细信息
	
	

	public Temp(String name, int yesNum, int noNum, List<WorkflowTask> task,List<HistoryWorkflowTask> historyTask) {
		super();
		this.name = name;
		this.yesNum = yesNum;
		this.noNum = noNum;
	...
	public Temp(String name, int yesNum, int noNum, int invaNum,
			List<WorkflowTask> task,List<HistoryWorkflowTask> historyTask) {
		super();
		this.name = name;
		this.yesNum = yesNum;
		this.noNum = noNum;
	...
	public List<HistoryWorkflowTask> getHistoryTask() {
		return historyTask;
	}

	public void setHistoryTask(List<HistoryWorkflowTask> historyTask) {
		this.historyTask = historyTask;
	}
