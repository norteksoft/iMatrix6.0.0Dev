...
public class UserDetailServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String loginName)
		...
		if(loginName.contains("%")){//表示是swing“办公助手”中访问v1/tickets过来的，有%表示用户登录名或分支编码有中文，已进行编码URLEncoder.encode(username, "utf-8")，需要解码
        	try {
...
//		}
	 ...
	 */
	private com.norteksoft.acs.entity.security.User createUserdetail(User user, Company company, List<GrantedAuthority> authsList,Department subCompany,String userinfo){
		com.norteksoft.acs.entity.security.User userdetail = 
			new com.norteksoft.acs.entity.security.User(user.getId(), userinfo, user.getPassword(), user.getEmail(),
