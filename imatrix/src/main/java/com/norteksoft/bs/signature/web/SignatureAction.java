...
public class SignatureAction extends CrudActionSupport<Signature> {
	...
	private String userNameInfo;//带有分支机构的
	...
	public String input() throws Exception {
		if(signatureId!=null){
			...
			if(ContextUtils.hasBranch()){
				if(StringUtils.isNotEmpty(signature.getSubCompanyName())){
					userNameInfo = signature.getUserName()+"("+signature.getSubCompanyName()+")";
				}else{
					userNameInfo = signature.getUserName();
