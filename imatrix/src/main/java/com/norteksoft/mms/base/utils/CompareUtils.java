...
public class CompareUtils {
	...
	public static boolean compareGET(DataType dt, Object src, Object dest){
		...
		case FLOAT: return new FloatCompare().compareGET((Float)src, (Float)dest);
		}
		return false;
	}
	...
	public static boolean compareLT(DataType dt, Object src, Object dest){
		...
		case FLOAT: return new FloatCompare().compareLT((Float)src, (Float)dest);
		}
		return false;
	}
	...
	public static boolean compareLET(DataType dt, Object src, Object dest){
		...
		case FLOAT: return new FloatCompare().compareLET((Float)src, (Float)dest);
		}
		return false;
	}
