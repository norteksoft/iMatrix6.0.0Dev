...
//	private Long tableColumnId;//数据表字段id  
	...
	private String saveDeptControlType;  //保存信息类型
	private String deptMultiple;//类型:多选或单选
	private String deptTreeType;//树的类型
	private String deptShowBranch;//是否显示分支
	//计算控件
	...
	//宏控件
	private String macroType;//宏控件类型
	private Boolean macroHide;//隐藏
	
	//多行文本框
	private String rich;//1:富文本形式,0:文本域
	
	//日期控件
	private String customType;//自定义类型
	
	
	public String getDeptShowBranch() {
		return deptShowBranch;
	}
	public void setDeptShowBranch(String deptShowBranch) {
		this.deptShowBranch = deptShowBranch;
	}
...
//	}
	...
	public String getSaveDeptControlType() {
		return saveDeptControlType;
	}
	public void setSaveDeptControlType(String saveDeptControlType) {
		this.saveDeptControlType = saveDeptControlType;
	}
	...
	public Boolean getMacroHide() {
		return macroHide;
	}
	public void setMacroHide(Boolean macroHide) {
		this.macroHide = macroHide;
	}
