...
public class CommonDao extends HibernateDao<Object, Long>{
	...
	public void save(JSONObject rowValue, String tableName,String fkKey ,Long fkKeyValue,Integer displayIndex) {
		jdbcDao.insertTable(rowValue, tableName, fkKey, fkKeyValue,displayIndex);
	}

	public void update(JSONObject rowValue, String tableName, String fkKey ,Long fkKeyValue, Long dataId,Integer displayIndex) {
		jdbcDao.updateTable(rowValue, tableName, fkKey, fkKeyValue ,dataId,displayIndex);
	}
