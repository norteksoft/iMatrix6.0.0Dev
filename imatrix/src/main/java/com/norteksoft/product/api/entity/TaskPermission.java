...
public class TaskPermission {
	...
	private Boolean opinionVisible=false;//查看意见
	...
	private Boolean documentTraceRetainable=false;//是否保留编辑痕迹
	private Boolean documentTraceVisible=false;//是否查看编辑痕迹（流程图的环节属性中设置【编辑/显示编辑痕迹】或【查看编辑痕迹】）
	private Boolean documentTraceView=false;//当没有【编辑】权限，但有【查看编辑痕迹】的权限时
	...
	public Boolean getOpinionVisible() {
		return opinionVisible;
	}

	public void setOpinionVisible(Boolean opinionVisible) {
		this.opinionVisible = opinionVisible;
	}

	public Boolean getDocumentTraceRetainable() {
		return documentTraceRetainable;
	}

	public void setDocumentTraceRetainable(Boolean documentTraceRetainable) {
		this.documentTraceRetainable = documentTraceRetainable;
	}

	public Boolean getDocumentTraceVisible() {
		return documentTraceVisible;
	}

	public void setDocumentTraceVisible(Boolean documentTraceVisible) {
		this.documentTraceVisible = documentTraceVisible;
	}

	public Boolean getDocumentTraceView() {
		return documentTraceView;
	}

	public void setDocumentTraceView(Boolean documentTraceView) {
		this.documentTraceView = documentTraceView;
	}
}
