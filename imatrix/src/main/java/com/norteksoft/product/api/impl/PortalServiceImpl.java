...
public class PortalServiceImpl implements PortalService {
	 ...
	 * @param url 弹窗的链接
	 */
	public void addMessage(String systemCode,String sender,Long senderId,Long receiverId,String category,
			String content, String url)
			throws Exception {
		messageManager.saveMessage(systemCode,sender, senderId,receiverId,category, content, url,MessageType.SYSTEM_MESSAGE);
	}
