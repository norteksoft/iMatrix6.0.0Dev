...
public class MmsServiceImpl implements MmsService {
	...
	public String getTopMenuUrl(String code){
		com.norteksoft.mms.module.entity.Menu menu = menuManager.getMenuByCodeWithoutCompany(code);
		if(menu!=null)return menu.getUrl();
		return null;
	}
	...
	public void deleteFormAttachments(String recordInfo) {
		formViewManager.deleteAttachmentsByRecordInfo(recordInfo);
	}

	public SingleSearch getSingleSearchCondition(String alias,List<Object> beforeValues,List<Object> afterValues) {
		return mmsUtil.getSingleSearchCondition(alias,beforeValues,afterValues);
	}
}
