...
public class Menu implements Serializable{
		...
		public Menu getParent(){
			if(StringUtils.isEmpty(this.code))return null;
			return ApiFactory.getMmsService().getParent(this.code);
		}
		public List<Menu> getChildren(){
			if(StringUtils.isEmpty(this.code))return new ArrayList<Menu>();
			return ApiFactory.getMmsService().getChildren(this.code);
		}
}
