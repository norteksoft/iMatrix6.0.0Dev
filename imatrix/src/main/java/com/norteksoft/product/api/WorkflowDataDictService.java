...
public interface WorkflowDataDictService {
	...
	/**
	 * 根据数据字典ID查询办理人登录名及用户名(会有相同登录名的问题)
	 * @param dictIds 数据字典id集合
	 ...
	 * 根据数据字典ID查询办理人id及用户名
	 * @param dictIds 数据字典id集合
	 * @return HashMap集合，key为userId，value为userName
	 */
