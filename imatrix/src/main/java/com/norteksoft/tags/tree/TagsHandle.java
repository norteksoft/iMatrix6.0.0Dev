		 ...
		 try{
			 ...
			 JspWriter out=pageContext.getOut(); 
			   ...
			   if(defaultable==true){
				    switch(treeType) {
				       case COMPANY:
				    	   out.print(getTreeTemplet(multiple,webapp+"/portal/tree.action?_date="+new Date().getTime()+"&treeType="+treeType+"&departmentDisplayType="+departmentDisplayType+"&userWithoutDeptVisible="+userWithoutDeptVisible+"&branchIds="+branchIds,webapp+"/portal/search-tree.action?treeType="+treeType+"&departmentDisplayType="+departmentDisplayType+"&userWithoutDeptVisible="+userWithoutDeptVisible+"&branchIds="+branchIds));break;
