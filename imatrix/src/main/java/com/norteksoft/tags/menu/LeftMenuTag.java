	...
	public int doStartTag() throws JspException {
		try {
			...
			if(lastMenuIdStr!=null){
				...
				Menu thirdMenu=menuManager.getDefaultSelectMenuByLayer(3,Long.parseLong(lastMenuIdStr));
				if(thirdMenu!=null){thirdMenuId=thirdMenu.getId();thirdMenuCode=thirdMenu.getCode();}
				Menu fourMenu=menuManager.getDefaultSelectMenuByLayer(4,Long.parseLong(lastMenuIdStr));
