...
function toPageNameClick(rowInputId){
	$.colorbox({href:webRoot+'/module/button!selectPage.htm?pageId='+$("#page_id1").attr("value")+'&menuId='+$("#menuId").attr("value")+'&rowid='+rowInputId,iframe:true, innerWidth:500, innerHeight:400,overlayClose:false,title:"选择页面"});
}
