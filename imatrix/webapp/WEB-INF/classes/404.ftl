...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%"
	...
	<TR>
		...
		<TABLE cellSpacing=0 cellPadding=0 width=500 align=center border=0>
				...
				<TABLE class=text cellSpacing=0 cellPadding=10 width="100%"
					...
					<TR>
						...
						<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
							<TR>
								<TD ><IMG src="${resourceCtx}/images/404.jpg" width=128 height=128 style="float: right;"></TD>
								<TD >
									<P  style="FONT-SIZE: 24px;font-weight: bold;margin:8px 0;font-family:黑体;">
										没有找到您要访问的页面，<br>请检查您是否输入正确URL或请联系管理员。
									</P>
									<p style="FONT-SIZE: 12px;COLOR: #777;margin:8px 0;"> HTTP 404 错误</p>
								</TD>
							</TR>
						</TABLE>
						</TD>
			...
			<TR>
				<TD width=17 height=17><IMG height=17 src="${resourceCtx}/images/co_03.gif"
					width=17></TD>
				<TD background="${resourceCtx}/images/bg04.gif" height=17></TD>
				<TD width=17 height=17><IMG height=17 src="${resourceCtx}/images/co_04.gif"
					width=17></TD>
			</TR>
		</TABLE>
