...
<head>
	...
	$(document).ready(function() {
		historyTree("completed_tree_id","complete_task");
	});
	function markColor(code){
		...
		if(validateReadioTaskIds()){
			...
			ajaxSubmit("task_form",encodeURI("${taskCtx }/task/history-workflow-task-mark.htm?typeName="+id+'&taskType='+taskType), "pageTablelist");
		}
	}
