				...
				<fieldset style="border: #f0f0ee solid 1px; padding: 3px;">
					...
					<tbody>
						<tr>
							...
							<td>
							 <s:if test="standard">
								<s:select theme="simple" id="controlType" onchange="controlTypeChange(this.value)" list="#{'TEXT':'文本框','PASSWORD':'密码框','HIDDEN':'隐藏域'}" 
						...
						<s:else>
							...
							<tr>	
								...
								<td>
									<s:select theme="simple" id="dataType" list="#{'TEXT':'文本','DATE':'日期','TIME':'时间','INTEGER':'整型','LONG':'长整型','DOUBLE':'双精度浮点数','FLOAT':'单精度浮点数','CLOB':'大文本'}" 
