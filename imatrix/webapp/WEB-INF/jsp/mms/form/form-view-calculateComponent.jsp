					...
					<table  class="form-table-without-border">
						...
						<s:if test="standard">
							...
							<tr>	
								...
								<td>
									<s:select theme="simple" id="dataType" list="#{'INTEGER':'整型','LONG':'长整型','DOUBLE':'双精度浮点数','FLOAT':'单精度浮点数','TEXT':'文本'}" 
						...
						<s:if test="standard">
					     ...
					     <tr>
					     	...
					     	<td >
				             <a href="#" onClick="mytip('tip')">计算公式填写说明</a>
				             <div style="font-size: 10pt;font-family:宋体;display:none;" id="tip">
							              计算公式支持+ - * / 和英文括号<br>以及特定计算函数，例如：<br>(数值1+数值2)*数值3-ABS(数值4)<br>
							              其中数值1、数值2等为表单控件字段<br>名。<br>
				              	 <b>当前版本所支持的计算函数：</b><br>
				              	1、MAX(数值1,数值2,数值3...)输出<br>最大值,英文逗号分割;<br>
				              	2、MIN(数值1,数值2,数值3...)输出<br>最小值,英文逗号分割;<br>
				              	3、ABS(数值1) 输出绝对值;<br>
				              	4、AVG(数值1,数值2,数值3)输出平<br>均值;<br>
				              	5、RMB(数值1)输出人民币大写形式，<br>数值范围0~9999999999.99<br>
				              	6、DAY(日期1,日期2)输出时间差的<br>天数<br>
				              	7、HOUR(日期1,日期2)输出时间差<br>的小时数<br>
				              	8、DATE(日期1,日期2)输出时间差，<br>形如：xx天xx小时xx分<br>
				              <b>注意：函数名称必须为大写字母；括<br>号和逗号均为英文的；
				              	参与日期计<br>算的控件必须为日期类型或者时间<br>类型。</b>
				              </div>
				            </td>
				            <td></td>
					     </tr>
