			...
			<aa:zone name="controlContent">
					<form name="dataForm" id="dataForm" action="${mmsCtx }/form/form-view!text.htm">
						...
						<table class="form-table-without-border">
						  ...
						  <tr>
						  	<td class="content-title">单行文本控件字段名：</td>
						  	<td>
						...
						<table style="width: 550px;">  
						 <tr style="width: 550px;">
							...
							<td style="width: 108px;">—单行文本控件字段名：</td><td style="width: 80px;"><input type="text" name="itemTitle" id="itemTitle"/></td><td style="width: 100px;"> <input type="checkbox" name="isQuery" id="isQuery" title="是否作为查询字段" style="display: none;"/>
