					...
					<fieldset style="border: #f0f0ee solid 1px; padding: 3px;">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<s:textfield theme="simple" id="controlId" name="formControl.controlId"  cssClass="{required:true,messages: {required:'必填'}}" onkeyup="value=this.value.replace(/[^-_A-Za-z0-9]/g,'');"></s:textfield>
								</td>
