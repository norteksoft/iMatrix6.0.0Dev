	...
	<div id="message" style="display:none;"><s:actionmessage theme="mytheme" /></div>
		<form id="inputForm" name="inputForm" action="" method="post">
			...
			<table class="form-table-without-border">
				...
				<tr>
					<td >权限设置：</td>
					<td> <input id="roleNames" name="roleNames" value="${roleNames}"  readonly="readonly"></input><input id="roleIds" name="roleIds" value="${roleIds}"  type="hidden"></input>&nbsp;&nbsp;<a href="#" onclick="addRole();" class="small-btn"><span><span>添加</span></span></a>&nbsp;<a href="#" onclick="clearRole();" class="small-btn"><span><span>清空</span></span></a></td>
				</tr>	
				<tr>
					<td >窗口参数：</td>
					<td> </td>
