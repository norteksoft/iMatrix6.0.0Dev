...
function _signatureSave(){
	...
	function customCallbackFun(){
		var trueName = ztree.getName();
		$("#userNameInfo").attr("value",trueName);
		$("#userId").attr("value",ztree.getId());
		$("#subCompanyName").attr("value",ztree.getSubCompanyName());
		var username = trueName;
		if(username.indexOf("(")>=0){
			username = trueName.substring(0,trueName.lastIndexOf("("));
		}
