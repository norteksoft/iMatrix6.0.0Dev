...
<head>
	...
	<script type="text/javascript">
		...
		function saveHoliday(){
			var dayOfWeekNum=$("input[name='dayOfWeek']:checked").size();
			if($("#_startDate").val()!=''||dayOfWeekNum>0){
...
<div class="ui-layout-center">
	...
	<s:if test="'DEPARTMENT' != nodeType">
		...
		<aa:zone name="holiday_zone">
			...
			<p style="padding: 6px 10px;font-size: 15px;color: red;">提示：日历中红色显示即为节假日，快速设置是设置当年的节假日</p>
			<table class="input" style="margin: 5px;">
				<tr>
					<td rowspan="7" style="padding-right:6px;">
				...
				<tr>
					<td rowspan="2">常规设置：</td>
				</tr>
				<tr>
					<td>开始日期：<input readonly="readonly" name="startDate" id="_startDate" value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"> <span style="color: red;padding: 4px;">*</span> 
					结束日期：<input readonly="readonly" name="endDate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})">
					</td>
				</tr>
				<tr>
					<td rowspan="2">快速设置：</td>
				</tr>
				<tr>
					<td>
						<input type="checkbox" name="dayOfWeek" value="7"/>周日
						<input type="checkbox" name="dayOfWeek" value="1"/>周一
						<input type="checkbox" name="dayOfWeek" value="2"/>周二
						<input type="checkbox" name="dayOfWeek" value="3"/>周三
						<input type="checkbox" name="dayOfWeek" value="4"/>周四
						<input type="checkbox" name="dayOfWeek" value="5"/>周五
						<input type="checkbox" name="dayOfWeek" value="6"/>周六
					</td>
				</tr>
				<tr>
					<td rowspan="2">设置为：</td>
