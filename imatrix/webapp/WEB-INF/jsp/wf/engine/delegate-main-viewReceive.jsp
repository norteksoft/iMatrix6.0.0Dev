...
<form action="" name="defaultForm" id="defaultForm" method="post"></form>
	<div class="opt-btn">
		<button class="btn" onclick="ajaxSubmit('defaultForm','${wfCtx}/engine/delegate-main!receive.htm','delegatemainlist');"><span><span >返回</span></span></button>
	</div>
	<div id="opt-content">
	<table class="Table">
			...
			<s:elseif test="style==3">
	 		...
	 		<tr style="height: 30px;">
	 			  <td>说明：</td>
				<td><textarea name="remark" cols="50" rows="5" readonly="readonly">${remark}</textarea></td>
		  	</tr>
		</table>
	</div>
</aa:zone>
