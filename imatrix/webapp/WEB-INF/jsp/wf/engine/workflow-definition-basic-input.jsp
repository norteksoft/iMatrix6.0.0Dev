			...
			<form id="inputForm" name="inputForm" action="" method="post">
				...
				<table class="form-table-without-border">
					...
					<tr>
						...
						<td><input name="adminName" value="${adminName}"  id="adminName" readonly="readonly"></input><input name="adminLoginName" value="${adminLoginName}" type="hidden" id="adminLoginName"></input><input name="adminId" value="${adminId}" type="hidden" id="adminId"></input><span class="required">*</span><a href="#" onclick='selectPerson();' title="选择"  class="small-btn" id="selectBtn"><span><span>选择</span></span></a></td>
						<td></td>
					</tr>
					...
					<tr>
					 ...
					 <s:if test="hasBranch">
						<tr>
							<td class="content-title">所属分支机构：</td>
							<td>
